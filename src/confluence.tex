...
In this section, we define a relation $\Pred^\alpha$ for parallel reduction with renaming.  This relation will be the desired
intermediate relation between $\abeta$ and $\abeta^*$, with the diamond property.  The relation $\Pred$ is defined
...
$\betaa_\beta$ (Definition~\ref{dec:betaa}):
...
\section{The maximal parallel contraction of a term}
