...
% beta reduction without renaming
\newcommand{\betar}[0]{\curva_\beta}

% beta reduction with renaming
\newcommand{\betaa}[0]{\curva}

% beta equivalence (with renaming)
\newcommand{\betaeq}[0]{\approx}

% union of beta and alpha reduction
\newcommand{\abeta}[0]{\hookrightarrow}
